...
class Packet_Type:
    ...
    # UDP associate and datagram relay
    UDP_ASSOCIATE = 0x31  # Client requests a UDP relay stream
    UDP_ASSOCIATE_ACK = 0x32  # ACK for UDP_ASSOCIATE
    UDP_DATA = 0x33  # Datagram payload with SOCKS5 address header
    UDP_CLOSE = 0x34  # Close UDP relay stream
    UDP_CLOSE_ACK = 0x35  # ACK for UDP_CLOSE
